...
import { ArrowDown, ArrowUp, ChevronDown, Coins, Info, ShoppingCart } from "lucide-react"
import {
  Table,
  TableBody,
  TableCell,
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="rounded-[16px] bg-card">
        ...
        >
          <h3 className="font-header text-xl sm:text-lg font-bold uppercase tracking-tight">{t("history")}</h3>
          <ChevronDown
            className={cn(
              "h-5 w-5 text-foreground/50 transition-transform duration-200",
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <span
                            className={cn(
                              ...
                              typeColors[movement.type as CreditMovementType]
                            )}
                          >
