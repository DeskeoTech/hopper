...
// Room card component with image slider
function RoomCard({
  room,
  onClick,
}: {
  ...
  return (
    <div
      ...
      className="w-[180px] shrink-0 overflow-hidden rounded-[16px] border bg-card text-left transition-all hover:shadow-md hover:border-primary/20 active:scale-[0.98] cursor-pointer"
    >
      {/* Room photo slider */}
            ...
            {hasMultiplePhotos && (
              <>
                ...
                <button
                  ...
                  className="absolute left-1 top-1/2 -translate-y-1/2 rounded-full bg-background/70 p-1 shadow-sm hover:bg-background transition-colors"
                >
                ...
                <button
                  ...
                  className="absolute right-1 top-1/2 -translate-y-1/2 rounded-full bg-background/70 p-1 shadow-sm hover:bg-background transition-colors"
                >
...
export function SiteInfoModal({ open, onOpenChange, site: siteProp }: SiteInfoModalProps) {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 z-50 bg-black/50 hidden md:block"
      ...
      <div className={cn(
        ...
        "md:w-full md:max-w-lg md:max-h-[85vh] md:rounded-2xl md:shadow-xl md:border"
      )}>
        {/* Header */}
        <div className="sticky top-0 z-10 flex items-center justify-between border-b bg-background px-4 py-3 md:rounded-t-2xl">
          <h1 className="font-heading text-base sm:text-lg font-bold">
            {site.name}
          </h1>
          <Button
            variant="ghost"
        ...
        <div className={cn(
          ...
          "md:h-auto md:max-h-[calc(85vh-57px)]"
        )}>
          {/* Photo gallery */}
